...
<li class="nav-item">
    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseEditProduct" aria-expanded="true" aria-controls="collapseEditProduct">
        <i class="fas fa-fw fa-folder"></i>
        <span>แก้ไขข้อมูลสินค้า</span>
    </a>
    <div id="collapseEditProduct" class="collapse" aria-labelledby="headingEditProduct" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
