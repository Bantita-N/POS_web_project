...
<head>
    ...
    <title>เพิ่มข้อมูลฝ่ายขาย</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                ...
                <form name="form1" method="post" action="insert_seller.php" enctype="multipart/form-data">
                    <div class="mb-3">
                        <label>ชื่อ</label>
                    ...
                    <a class="btn btn-danger" href="report_seller.php" role="button">Cancel</a>
                </form>
            </div>
        </div>
    </div>
